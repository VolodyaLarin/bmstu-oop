...
auto vm = sf::VideoMode::getDesktopMode();
  ...
  while (window.isOpen()) {
    ...
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::Add) || sf::Keyboard::isKeyPressed(sf::Keyboard::Num1)) {
      request.action = action_scale;
    ...
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::Subtract)|| sf::Keyboard::isKeyPressed(sf::Keyboard::Num2)) {
      request.action = action_scale;
